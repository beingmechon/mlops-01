...
# captcha_recognition_torch documentation build
...
from captcha_recognition_torch import __version__ as release

# -- Project information -----------------------------------------------------

project = "captcha_recognition_torch"
author = "Kedro"
...
htmlhelp_basename = "captcha_recognition_torchdoc"
...
latex_documents = [
    (
        master_doc,
        "captcha_recognition_torch.tex",
        "captcha_recognition_torch Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "captcha_recognition_torch",
        "Project captcha_recognition_torch codebase.",
        "Data-Science",
    )
]
